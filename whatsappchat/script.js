...
const questionBank = [
	{ question: "Tumhara favourite color kya hai?", answers: ["blue", "red", "green", "black", "white", "yellow", "pink", "neela", "lal", "hara"], reply: "Nice choice! Mera favourite color green hai 💚" },
	{ question: "Tumhe chai pasand hai ya coffee?", answers: ["chai", "tea", "coffee", "coffe"], reply: "Wah! Ek cup saath mein ho jaye ☕" },
	{ question: "Aaj tumhara din kaisa ja raha hai?", answers: ["good", "great", "acha", "achha", "theek", "thik", "bad", "bura", "fine"], reply: "Batane ke liye thanks! 😊" },
	{ question: "Tumhe music pasand hai?", answers: ["yes", "haan", "ha", "no", "nahi", "nahin"], reply: "Music mood ko instantly better kar deta hai 🎵" }
];
...
function getBotReply(text){
	...
	if(activeQuestion){
		...
		const answerReply = answerMatches ? activeQuestion.reply : "Thoda aur clearly batao, please 🙂";
		activeQuestion = null;
		return answerReply + "\n\n" + askRandomQuestion();
	}
